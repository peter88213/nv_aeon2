[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_aeon2/raw/main/dist/nv_aeon2_v5.1.2.pyzw)
...
Download the latest release [nv_aeon2_v5.1.2.pyzw](https://github.com/peter88213/nv_aeon2/raw/main/dist/nv_aeon2_v5.1.2.pyzw)

- Launch *nv_aeon2_v5.1.2.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python nv_aeon2_v5.1.2.pyzw` (Windows), resp. `python3 nv_aeon2_v5.1.2.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [nv_aeon2_v5.1.2.zip](https://github.com/peter88213/nv_aeon2/raw/main/dist/nv_aeon2_v5.1.2.zip)
